...
// Auth information
global.pairNumber = "94717518710";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["94717518710", "94717518710"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["94717518710", "94717518710"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["94717518710"];
global.OwnerName = process.env.OWNER_NAME || "S H A G E E";
